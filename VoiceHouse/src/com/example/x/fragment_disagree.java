...
import com.example.x.fragment_disagree.CommentsAdapter.MyCommentHolder;
...
public class fragment_disagree extends Fragment implements android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		refresh = (android.support.v4.widget.SwipeRefreshLayout)v.findViewById(R.id.refresh);
		refresh.setOnRefreshListener(this);
		refresh.setColorSchemeColors(Color.BLACK, Color.DKGRAY, Color.GRAY, Color.WHITE);
				...
				for (int i = 0; i < arra.length(); i++) {
					...
					commentList.add(new Comment(jObject.getString("name"),
							jObject.getString("comment"), jObject
									...
									.getInt("nmbr_of_ilogical"),12,jObject.getString("client_id")));
				}
			} catch (Exception e) {
	...
	class CommentsAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View v = inflater.inflate(R.layout.single_reply_comment, parent, false);
			...
			holder.illogical.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(hld.illogical.getAlpha()==0.7f )
					{
						...
						hld.illogicals+=1;
						hld.illogical.setText(hld.illogicals+" Illogicals");
